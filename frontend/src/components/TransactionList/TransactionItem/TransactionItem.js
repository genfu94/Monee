  ...
  return (
    <div className="flex-centered selectable-item transaction">
      ...
      <div className="flex-centered transaction-info">
          ...
          <div className="flex-centered transaction-info-description">{transaction.text}</div>
        </div>
        <div className="flex-centered-vertical transaction-amount-section">
          <div className={`${transaction.transaction_amount.amount > 0 ? "transaction-income":"target-currency-transaction-amount"}`}>{transaction.transaction_amount.currency}&nbsp;{transaction.transaction_amount.amount}</div>
